              ...
              <div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="file" name="product_image" accept="image/x-png,image/jpeg"  class="form-control">
		        	</div>
        		</div>
            <input type="hidden" name="add_product" value="1" >
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-product" onclick="myFunction()">Add Product</button>
...
// 	move_uploaded_file($_FILES["product_image"]["tmp_name"],$path."/ecommerce-app-h/product_image"."/".$_FILES["product_image"]["name"]);
...
// 	$product_image='/ecommerce-app-h/product_image/'.$_FILES["product_image"]["name"];
	

// 	$insertitems="INSERT INTO products(product_cat, product_brand, product_title, product_qty, product_price,product_desc, product_image, product_keywords) VALUES ('$category_id', '$brand_id', '$product_name', '$product_qty', '$product_price', '$product_desc', '$product_image', '$product_keywords')";
